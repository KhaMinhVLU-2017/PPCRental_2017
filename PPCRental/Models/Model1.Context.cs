...
namespace PPCRental.Models
{
    ...
    public partial class PPCRentalEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> PPC_District()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("PPC_District");
        }
    
        public virtual ObjectResult<string> PPC_Street(string districtName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("PPC_Street", districtNameParameter);
        }
    
        public virtual ObjectResult<string> PPC_Ward(string districtName)
        {
            var districtNameParameter = districtName != null ?
                new ObjectParameter("DistrictName", districtName) :
                new ObjectParameter("DistrictName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("PPC_Ward", districtNameParameter);
        }
